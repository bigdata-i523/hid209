...
class Date_parsingCommand(PluginCommand):
    # noinspection PyUnusedLocal
    @command
    def do_date_parsing(self, args, arguments):
        """
        ::

          Usage:
                date_parsing -g
                date_parsing generate

          This command does some useful things.

          Arguments:
              generate   automatic generate all yaml files

          Options:
              -g      has the same usage of generate command
        ...
        section_list = ["Logistic", "Theory", "Practice", "Writing",
